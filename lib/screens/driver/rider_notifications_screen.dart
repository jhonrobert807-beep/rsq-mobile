...
class RDNotificationsSettingsScreen extends StatefulWidget {
  const RDNotificationsSettingsScreen({super.key});

  @override
  State<RDNotificationsSettingsScreen> createState() => _RDNotificationsSettingsScreenState();
}

class _RDNotificationsSettingsScreenState extends State<RDNotificationsSettingsScreen> {
