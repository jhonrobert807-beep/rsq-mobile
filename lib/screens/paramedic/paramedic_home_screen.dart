      ...
      child: Column(
        children: [
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Welcome ${context.read<AuthProvider>().currentUser?.name ?? 'Paramedic'}!',
          ...
          _drawerItem(
            ...
            () => Navigator.pushReplacementNamed(
              context,
              AppRoutes.paramedicnotificationsSetting,
            ),
          ),
          _drawerItem(
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          GestureDetector(
            onTap: () => Navigator.pushReplacementNamed(context, AppRoutes.paramedicProfileScreen),
